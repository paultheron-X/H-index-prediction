...
parser = argparse.ArgumentParser(description="Générer les features de chaque node (leur hindex)")
parser.add_argument("authors_features")
parser.add_argument("authors_hindex")
